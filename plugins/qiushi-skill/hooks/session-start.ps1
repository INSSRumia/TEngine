...
$sessionContext = @"
<QIUSHI_SKILL>
Loaded qiushi:arming-thought. Follow user instructions, project constraints, and host platform rules first. Use this methodology as a supplemental routing and validation framework only when it clearly helps.
