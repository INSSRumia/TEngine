...
{
public sealed partial class AndConditionConfig : ExpeditionConditionConfig
{
    public AndConditionConfig(JSONNode _buf)  : base(_buf) 
    {
    ...
    public static AndConditionConfig DeserializeAndConditionConfig(JSONNode _buf)
    {
        return new Gameplay.Expedition.AndConditionConfig(_buf);
    }

    public readonly System.Collections.Generic.List<Gameplay.Expedition.ExpeditionConditionConfig> Conditions;
   
    public const int __ID__ = -186937909;
