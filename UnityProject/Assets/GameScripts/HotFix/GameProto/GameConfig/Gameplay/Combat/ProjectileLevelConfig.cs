...
public sealed partial class ProjectileLevelConfig : Luban.BeanBase
{
    public ProjectileLevelConfig(JSONNode _buf) 
    {
        ...
        { if(!_buf["tracking_ability"].IsObject) { throw new SerializationException(); }  TrackingAbility = global::GameConfig.Gameplay.Combat.ProjectileTrackConfig.DeserializeProjectileTrackConfig(_buf["tracking_ability"]);  }
    ...
    public readonly Gameplay.Combat.ProjectileTrackConfig TrackingAbility;
    ...
    public  void ResolveRef(Tables tables)
    {
        ...
        TrackingAbility?.ResolveRef(tables);
