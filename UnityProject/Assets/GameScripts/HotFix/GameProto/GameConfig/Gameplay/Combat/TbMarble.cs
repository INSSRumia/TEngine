...
{
    private readonly System.Collections.Generic.Dictionary<string, Gameplay.Combat.MarbleConfig> _dataMap;
    private readonly System.Collections.Generic.List<Gameplay.Combat.MarbleConfig> _dataList;
    ...
    public TbMarble(JSONNode _buf)
    {
        ...
        {
            Gameplay.Combat.MarbleConfig _v;
            { if(!_ele.IsObject) { throw new SerializationException(); }  _v = global::GameConfig.Gameplay.Combat.MarbleConfig.DeserializeMarbleConfig(_ele);  }
            _dataList.Add(_v);
